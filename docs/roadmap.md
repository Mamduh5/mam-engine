...
ENGINE-GAP-001A is complete in 0.2.0 and ENGINE-GAP-001B in 0.3.0. ENGINE-GAP-001C is complete in 0.4.0: optional targeting project authoring, deterministic separate bundle synchronization, a fail-closed loader, a scene-free production targeting core/runtime, explicit candidates and visibility, stable ties, retention/grace/reacquisition, directional switching/cooldown, shared controlled-fixture use, and packed external-consumer evidence. GAME-003 camera and GAME-004 enemy/targeting integration remain game-owned follow-up work.
