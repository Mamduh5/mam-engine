...
function isSnapshotRecord(value: unknown): value is SnapshotRecord {
  ...
  return record.metadataVersion === 1
    ...
    && (record.definitionKind === undefined || record.definitionKind === "movement-profile" || record.definitionKind === "camera-profile" || record.definitionKind === "targeting-profile" || record.definitionKind === "defensive-action-profile" || record.definitionKind === "offensive-action-profile" || record.definitionKind === "health-profile");
}
