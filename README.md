...
- Defensive, offensive, health, stamina, targeted-combat, real Godot action-timeline synchronization, canonical Phase 5 spherical contact-volume, canonical Phase 6 damage-reaction, and canonical Phase 7 end-to-end training-weapon proofs exist; enemies, encounters, and later combat composition remain roadmap work.
