...
func _execute(paths: Dictionary) -> void:
	...
	elif request.fixtureId == RuntimeProtocol.CONTACT_VOLUME_FIXTURE_ID:
		fixture = ContactVolumeFixtureScene.instantiate()
		add_child(fixture)
		fixture_scene = "res://scenes/contact_volume_fixture.tscn"
	elif request.fixtureId == RuntimeProtocol.DAMAGE_REACTION_FIXTURE_ID:
		fixture = DamageReactionFixtureScene.instantiate()
		add_child(fixture)
		fixture_scene = "res://scenes/damage_reaction_fixture.tscn"
	elif request.fixtureId == RuntimeProtocol.WEAPON_FIXTURE_ID:
	...
	elif request.fixtureId == RuntimeProtocol.ENCOUNTER_FIXTURE_ID:
		fixture = EncounterFixtureScene.instantiate()
		add_child(fixture)
		fixture_scene = "res://scenes/encounter_fixture.tscn"
	...
	elif request.fixtureId == RuntimeProtocol.ENCOUNTER_FIXTURE_ID: fixture.configure(request.payload)
